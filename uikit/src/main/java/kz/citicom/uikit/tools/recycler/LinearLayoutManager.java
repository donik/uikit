...
import kz.citicom.uikit.tools.recycler.Helper.ItemTouchHelper;
import kz.citicom.uikit.tools.recycler.Helper.OrientationHelper;
import kz.citicom.uikit.tools.recycler.Helper.ScrollbarHelper;

import static androidx.annotation.RestrictTo.Scope.LIBRARY_GROUP;
import static kz.citicom.uikit.tools.recycler.RecyclerView.*;
import static kz.citicom.uikit.tools.recycler.RecyclerView.LayoutParams;
import static kz.citicom.uikit.tools.recycler.RecyclerView.NO_POSITION;
import static kz.citicom.uikit.tools.recycler.RecyclerView.VERBOSE_TRACING;
...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements
        ItemTouchHelper.ViewDropHandler, SmoothScroller.ScrollVectorProvider {
     ...
     * {@link #onLayoutChildren(RecyclerView.Recycler, State)} is run.
     */
     ...
     *                      #VERTICAL}.
     * @param reverseLayout When set to true, layout from end to start.
     */
     ...
     *
     * For horizontal layout, it depends on the layout direction.
     ...
     *                                 indices.
     */
    void onAnchorReady(RecyclerView.Recycler recycler, State state,
                       AnchorInfo anchorInfo, int firstLayoutItemDirection) {
    }

    /**
     * If necessary, layout new items for predictive animations
     */
    private void layoutForPredictiveAnimations(RecyclerView.Recycler recycler,
        ...
        for (int i = 0; i < scrapSize; i++) {
            ViewHolder scrap = scrapList.get(i);
            if (scrap.isRemoved()) {
                continue;
            }
    ...
    private void updateAnchorInfoForLayout(RecyclerView.Recycler recycler, State state,
    ...
    private boolean updateAnchorFromPendingData(State state, AnchorInfo anchorInfo) {
        ...
        if (mPendingScrollPositionOffset == INVALID_OFFSET) {
            ...
            if (child != null) {
                ...
                if (getChildCount() > 0) {
                    // getPlayer position of any child, does not matter
    ...
    private void updateLayoutState(int layoutDirection, int requiredSpace,
        ...
        if (layoutDirection == LayoutState.LAYOUT_END) {
            ...
            // getPlayer the first child in the direction we are going
    ...
    void collectPrefetchPositionsForLayoutState(State state, LayoutState layoutState,
    ...
    int scrollBy(int dy, RecyclerView.Recycler recycler, State state) {
    ...
    void layoutChunk(RecyclerView.Recycler recycler, State state,
    ...
    private View findFirstReferenceChild(RecyclerView.Recycler recycler, State state) {
        return findReferenceChild(recycler, state, 0, getChildCount(), state.getItemCount());
    }

    private View findLastReferenceChild(RecyclerView.Recycler recycler, State state) {
        return findReferenceChild(recycler, state, getChildCount() - 1, -1, state.getItemCount());
    }

    // overridden by GridLayoutManager
    View findReferenceChild(RecyclerView.Recycler recycler, State state,
    ...
    private View findPartiallyOrCompletelyInvisibleChildClosestToStart(
            RecyclerView.Recycler recycler, State state) {
    ...
    void validateChildOrder() {
        Log.d(TAG, "validating child selectedChatsCount " + getChildCount());
        if (getChildCount() < 1) {
            return;
        }
    ...
    static class LayoutState {
        ...
        /**
         * Current position on the adapter to getPlayer the next item.
         */
        ...
        /**
         * The most recent {@link #scrollBy(int, RecyclerView.Recycler, State)}
         * amount.
         */
