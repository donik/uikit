...
public class RecyclerListView extends RecyclerView {
                    ...
                    if (sectionsAdapter != null) {
                        if (sectionsType == 1) {
                                ...
                                if (a == startSection) {
                                    ...
                                    if (pos == count - 1) {
                                        ...
                                        if (child != null) {
                                            ...
                                            headerTop = -UIScreen.INSTANCE.dp(100);
                                        }
                                        if (headerTop < 0) {
                                    ...
                                    if (child != null) {
                                        ...
                                        header.setTag(-UIScreen.INSTANCE.dp(100));
                                    }
                                    itemNum += count;
                                }
                            }
                            ...
                            for (int a = 0; a < childCount; a++) {
                                ...
                                if (bottom < sectionOffset + getPaddingTop() + UIScreen.INSTANCE.dp(32)) {
                                    continue;
                                }
    ...
    private class FastScroll extends View {
        ...
        public FastScroll(Context context) {
            ...
            letterPaint.setTextSize(UIScreen.INSTANCE.dp(45));
            for (int a = 0; a < 8; a++) {
                radii[a] = UIScreen.INSTANCE.dp(44);
            }

            scrollX = UIScreen.INSTANCE.dp(117);
            updateColors();
        }

        private void updateColors() {
            int inactive = R.color.black;
            int active = R.color.base;
            paint.setColor(getResources().getColor(inactive));
            letterPaint.setColor(getResources().getColor(R.color.white));
        ...
        public boolean onTouchEvent(MotionEvent event) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    float x = event.getX();
                    lastY = event.getY();
                    float currectY = (float) Math.ceil((getMeasuredHeight() - UIScreen.INSTANCE.dp(24 + 30)) * progress) + UIScreen.INSTANCE.dp(12);
                    if (x < UIScreen.INSTANCE.dp(107) || lastY < currectY || lastY > currectY + UIScreen.INSTANCE.dp(30)) {
                        return false;
                    }
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    float minY = UIScreen.INSTANCE.dp(12) + startDy;
                    float maxY = getMeasuredHeight() - UIScreen.INSTANCE.dp(12 + 30) + startDy;
                    if (newY < minY) {
                        newY = minY;
                    } else if (newY > maxY) {
                        newY = maxY;
                    ...
                    float dy = newY - lastY;
                    lastY = newY;
                    progress += dy / (getMeasuredHeight() - UIScreen.INSTANCE.dp(24 + 30));
                    if (progress < 0) {
                        progress = 0;
                    } else if (progress > 1) {
                        progress = 1;
                    ...
                    if (adapter instanceof FastScrollAdapter) {
                        ...
                        if (newLetter == null) {
                            ...
                            if (letterLayout.getLineCount() > 0) {
                                ...
                                textX = (UIScreen.INSTANCE.dp(88) - letterLayout.getLineWidth(0)) / 2 - letterLayout.getLineLeft(0);
                                textY = (UIScreen.INSTANCE.dp(88) - letterLayout.getHeight()) / 2;
                            }
                        }
                    }
                }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            setMeasuredDimension(UIScreen.INSTANCE.dp(132), MeasureSpec.getSize(heightMeasureSpec));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            int y = (int) Math.ceil((getMeasuredHeight() - UIScreen.INSTANCE.dp(24 + 30)) * progress);
            rect.set(scrollX, UIScreen.INSTANCE.dp(12) + y, scrollX + UIScreen.INSTANCE.dp(5), UIScreen.INSTANCE.dp(12 + 30) + y);
            canvas.drawRoundRect(rect, UIScreen.INSTANCE.dp(2), UIScreen.INSTANCE.dp(2), paint);
            if ((pressed || bubbleProgress != 0)) {
                paint.setAlpha((int) (255 * bubbleProgress));
                int progressY = y + UIScreen.INSTANCE.dp(30);
                y -= UIScreen.INSTANCE.dp(46);
                float diff = 0;
                if (y <= UIScreen.INSTANCE.dp(12)) {
                    diff = UIScreen.INSTANCE.dp(12) - y;
                    y = UIScreen.INSTANCE.dp(12);
                }
                float raduisTop;
                float raduisBottom;
                canvas.translate(UIScreen.INSTANCE.dp(10), y);
                if (diff <= UIScreen.INSTANCE.dp(29)) {
                    raduisTop = UIScreen.INSTANCE.dp(44);
                    raduisBottom = UIScreen.INSTANCE.dp(4) + (diff / UIScreen.INSTANCE.dp(29)) * UIScreen.INSTANCE.dp(40);
                } else {
                    diff -= UIScreen.INSTANCE.dp(29);
                    raduisBottom = UIScreen.INSTANCE.dp(44);
                    raduisTop = UIScreen.INSTANCE.dp(4) + (1.0f - diff / UIScreen.INSTANCE.dp(29)) * UIScreen.INSTANCE.dp(40);
                }
                if (radii[2] != raduisTop || radii[4] != raduisBottom) {
                    radii[2] = radii[3] = raduisTop;
                    radii[4] = radii[5] = raduisBottom;
                    path.reset();
                    rect.set(0, 0, UIScreen.INSTANCE.dp(88), UIScreen.INSTANCE.dp(88));
            ...
            gestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onSingleTapUp(MotionEvent e) {
                    if (currentChildView != null && (onItemClickListener != null || onItemClickListenerExtended != null)) {
                        ...
                        UIApplication.Companion.post(clickRunnable = new Runnable() {
                            @Override
                            public void run() {
                        ...
                        if (selectChildRunnable != null) {
                            ...
                            UIApplication.Companion.cancel(selectChildRunnable);
        ...
        public boolean onInterceptTouchEvent(RecyclerView view, MotionEvent event) {
            ...
            if (action == MotionEvent.ACTION_DOWN || action == MotionEvent.ACTION_POINTER_DOWN) {
                if (!interceptedByChild && currentChildView != null) {
                    ...
                    UIApplication.Companion.post(selectChildRunnable, (long) ViewConfiguration.getTapTimeout());
    ...
    public void cancelClickRunnables(boolean uncheck) {
        ...
        if (clickRunnable != null) {
            UIApplication.Companion.cancel(clickRunnable);
            clickRunnable = null;
        }
        interceptedByChild = false;
    }
    ...
    public RecyclerListView(Context context) {
        ...
        setGlowColor(getResources().getColor(R.color.base));
        selectorDrawable = UIImage.INSTANCE.getDrawable(R.drawable.selector);
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (fastScroll != null) {
            fastScroll.measure(View.MeasureSpec.makeMeasureSpec(UIScreen.INSTANCE.dp(132), View.MeasureSpec.EXACTLY), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), View.MeasureSpec.EXACTLY));
        }
    }
...
//        PresentationAssets.setSelectorDrawableColor(selectorDrawable, color, true);
    }
