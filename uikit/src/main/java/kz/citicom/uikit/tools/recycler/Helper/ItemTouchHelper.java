...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (mRecyclerView != null) {
            ...
            mSwipeEscapeVelocity = UIScreen.INSTANCE.dp(120);
            mMaxSwipeVelocity = UIScreen.INSTANCE.dp(800);
            setupCallbacks();
        }
    }
    ...
    public interface ViewDropHandler {
         ...
         * <p>
         * A LayoutManager should implement this interface to getPlayer ready for the upcoming move
         * operation.
         * <p>
     ...
     * actionMove(recyclerView, dragged, target)}.
    ...
    public abstract static class Callback {
         ...
         *
         * @param actionState The action state you want to getPlayer flags in. Should be one of
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (mCachedMaxScrollSpeed == -1) {
                mCachedMaxScrollSpeed = UIScreen.INSTANCE.dp(20);
            }
     ...
     * directions and this class will handle the flag callbacks. You should still override actionMove
     * or
     ...
     *         public abstract boolean actionMove(RecyclerView recyclerView,
     *             ViewHolder viewHolder, ViewHolder target) {
