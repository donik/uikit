...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public int getRowCountForAccessibility(RecyclerView.Recycler recycler,
        ...
        // Row selectedChatsCount is one more than the last item's row index.
    ...
    public int getColumnCountForAccessibility(RecyclerView.Recycler recycler,
        ...
        // Column selectedChatsCount is one more than the last item's column index.
        return getSpanGroupIndex(recycler, state, state.getItemCount() - 1) + 1;
    }
    ...
    /**
     * Sets the source to getPlayer the number of spans occupied by each item in the adapter.
     *
    ...
    private void ensureAnchorIsInCorrectSpan(RecyclerView.Recycler recycler,
        ...
        if (layingOutInPrimaryDirection) {
            ...
            // choose the max span we can getPlayer. hopefully last one
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        int maxSize = 0;
        float maxSizeInOther = 0; // use a float to getPlayer size per span
    ...
    public void setSpanCount(int spanCount) {
        ...
        if (spanCount < 1) {
            throw new IllegalArgumentException("Span selectedChatsCount should be at least 1. Provided "
                    + spanCount);
        }
